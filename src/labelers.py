...
def norm_from_chequeado(x):     return _pick(x, ["verdadero"], ["falso","engañoso"], ["insustancial","dudoso"])
def norm_from_efe(x):           return _pick(x, ["verdadero"], ["falso","engañoso"], ["no verificable","dudoso"])
def norm_from_verificat(x):     return _pick(x, ["cierto","verdadero"], ["falso","enganyos"], ["dubtós","dudoso"])
def norm_from_sabueso(x):       return _pick(x, ["verdadero"], ["falso","engañoso"], ["dudoso"])
def norm_from_verificadomx(x):  return _pick(x, ["verdadero"], ["falso","bulo"], ["dudoso"])
...
LABELERS = {
    ...
    "afp": norm_from_afp,
    "maldita": norm_from_maldita,
    "newtral": norm_from_newtral,
    "chequeado": norm_from_chequeado,
    "efe": norm_from_efe,
    "verificat": norm_from_verificat,
    "sabueso": norm_from_sabueso,
    "verificadomx": norm_from_verificadomx,
